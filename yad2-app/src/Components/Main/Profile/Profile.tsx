  ...
  return (
    <div className="Profile">
      <div className="ProfileMain">
        <div className="ProfileMainPersonalDetailsDiv">
          ...
          <div className="ProfileMainPersonalDetails">
            <p>
              <b>Name: </b> <br /> {user?.firstName} {user?.lastName}
            </p>
            <p>
            ...
            <p>
              <b>Country: </b> <br /> {user?.country}
            </p>
            <p>
              <b>City: </b> <br /> {user?.city}
            </p>
          </div>
        </div>
      ...
      <div className="ProfileProductsChoose">
        <button
          onClick={() =>
            profileFunctions.getCartProducts(isCart, setIsCart, id, setProducts)
          }
        >
          {isCart ? "Click to show Cart" : "Click to show own listed products"}
        </button>
